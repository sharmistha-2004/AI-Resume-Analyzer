...
└── README.md
💡 How It Works
User uploads resume and enters target role.
Resume text is extracted using PyPDF2 or python-docx.
Prompt is generated and sent to Groq’s LLaMA3 via LangChain.
AI analyzes tone, relevance, structure, keywords, etc.
An ATS check is also performed for compatibility with job boards.
Feedback + score is rendered in Streamlit UI with copy option.
🌟 Live Demo
🧪 Try it live: AI Resume Analyzer Streamlit App
